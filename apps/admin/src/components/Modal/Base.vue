...
const props = withDefaults(
    defineProps<{
        ...
        description?: string
        class?: string
        /** When false, the main content area between header and footer is not rendered. */
        showBody?: boolean
    }>(),
    {
        title: '',
...
const ui = computed(() => {
    ...
    return {
        ...
        body: showBody ? 'px-4 py-4' : 'hidden p-0',
        footer: [
            showBody ? 'border-t border-gray-200 dark:border-dark-600' : 'border-t-0',
